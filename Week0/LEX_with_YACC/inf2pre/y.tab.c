...
{
  "$end", "error", "$undefined", "VAR", "NEWLINE", "OP1", "OP2", "'('",
...
#line 21 "yacc.y" /* yacc.c:1646  */
    { printf("%s \n",(yyvsp[-1].String)); exit(1);}
#line 1220 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 24 "yacc.y" /* yacc.c:1646  */
    {(yyval.String)= make_prefix((yyvsp[-2].String),(yyvsp[-1].String),(yyvsp[0].String));}
