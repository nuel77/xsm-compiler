...
static int REG_COUNT=-1, LABEL_COUNT=0, CURR_BINDING= 4096, LOCAL_BIND=1, PARAM_BIND=1,flabel=0,F_INDEX=0;
...
enum NodeType{
    ...
    _READ_PTR, _ASGN_PTR_ADDR, _FUNC, _RET, _ARG,_INIT, _ALLOC,_FREE, _FIELD, _ASSIGN_FIELD, _READ_FIELD, _NULL
};
